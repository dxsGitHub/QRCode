...
@implementation QuickMarkGenerate
...
+ (UIImage *)generateWithDefaultQRCodeData:(NSString *)data imageViewWidth:(CGFloat)imageViewWidth {
    ...
    return [QuickMarkGenerate createNonInterpolatedUIImageFormCIImage:outputImage withSize:imageViewWidth];
}
...
+ (UIImage *)generateQRCodeWithData:(NSString *)data mainCodeColor:(UIColor *)codeColor backgroundColor:(UIColor *)backgroundColor {
    ...
    [color_filter setValue:[CIColor colorWithCGColor:codeColor.CGColor] forKey:@"inputColor0"];
